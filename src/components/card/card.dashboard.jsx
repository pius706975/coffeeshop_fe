...
function CardDashboard(props) {
    ...
    const detail = () => {
        navigate(`/dashboard/detail/${props.id}`)
    }
        ...
        <div className="detail">
            <Card className="detail-card" style={{ width: `${cardWidth}px`, height: '340px', borderRadius: '20px', padding: '10px', marginRight: '10px', marginBottom: '10px' }}>
                ...
                <div className="row" style={{ padding: '0px 10px 0 10px' }}>
                    <Button className="detail-btn" style={{ color: 'white', fontSize: `${fontSize.button}px`, fontWeight: '600', backgroundColor: '#ff7c25', border: '1px solid #ff7c25', borderRadius: '10px' }} onClick={detail}>Edit</Button>
                </div>
            </Card>
        </div>
    )
